...
Olsen Light is a stunning blogging theme for WordPress. Specially crafted for lifestyle & fashion bloggers, Olsen Light guarantees the smoothest reading experience.

Theme page: https://www.cssigniter.com/ignite/themes/olsen-light/
Demo: https://www.cssigniter.com/preview/olsenlight/

Olsen Light WordPress Theme, Copyright 2015-2016 CSSIgniter LLC
...
* matchHeight - http://brm.io/jquery-match-height/
	Copyright 2014 liabru
	Released under the MIT license - http://opensource.org/licenses/MIT
* jQuery mmenu v5.2.0 - http://mmenu.frebsite.nl
...
* Added home slider.
* Moved ci_theme_get_social_networks() into /functions.php
